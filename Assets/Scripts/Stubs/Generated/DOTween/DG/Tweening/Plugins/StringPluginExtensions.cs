...
{
	internal static class StringPluginExtensions // TypeDefIndex: 3595
	{
		// Fields
		...
		// Constructors
		static StringPluginExtensions() {} // 0x004D3610-0x004D3760
	
		// Extension methods
		internal static void ScrambleChars(this char[] chars) {} // 0x004D3760-0x004D38A0
		internal static StringBuilder AppendScrambledChars(this StringBuilder buffer, int length, char[] chars) => default; // 0x004D33A0-0x004D3520
	}
}
